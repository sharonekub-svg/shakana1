...
const styles = StyleSheet.create({
  screen: { flexGrow: 1, width: '100%', maxWidth: 430, alignSelf: 'center', paddingHorizontal: 16, paddingTop: 18, paddingBottom: 104, gap: 14 },
  header: { gap: 5, paddingTop: 4, alignItems: 'center' },
  brand: { color: colors.mu, fontFamily: fontFamily.bodyBold, fontSize: 11, letterSpacing: 1.6 },
  title: { color: colors.tx, fontFamily: fontFamily.bodyBold, fontSize: 18, lineHeight: 24, textAlign: 'center' },
  subtitle: { color: colors.mu, fontFamily: fontFamily.body, fontSize: 13, lineHeight: 20, maxWidth: 320, textAlign: 'center' },
  identityCard: {
  ...
  avatarText: { color: colors.ink, fontFamily: fontFamily.display, fontSize: 36 },
  identityCopy: { alignItems: 'center', minWidth: 0, gap: 2 },
  name: { color: colors.tx, fontFamily: fontFamily.bodyBold, fontSize: 22, textAlign: 'center' },
  email: { marginTop: 2, color: colors.mu, fontFamily: fontFamily.body, fontSize: 13, textAlign: 'center' },
  verifiedBadge: {
    marginTop: 7,
  ...
  quickCardPrimary: { backgroundColor: colors.ink, borderColor: colors.ink },
  ...
  quickBadgePrimary: { backgroundColor: colors.acc, borderColor: colors.acc },
  quickBadgeText: { color: colors.tx, fontFamily: fontFamily.bodyBold, fontSize: 12 },
  quickBadgeTextPrimary: { color: colors.ink },
  ...
  quickBodyPrimary: { color: 'rgba(255,255,255,0.74)' },
  section: {
    gap: 12,
    padding: 15,
    borderRadius: 24,
