...
const styles = StyleSheet.create({
  ...
  button: { flexGrow: 1, minHeight: 48, borderRadius: radii.pill, borderWidth: 1, borderColor: colors.br, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16, backgroundColor: colors.white },
  ...
  buttonTextPrimary: { color: colors.tx },
});
