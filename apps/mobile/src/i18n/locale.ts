...
const messages = {
  he: {
    ...
    auth: {
      ...
      phone: {
        title: 'מה כתובת האימייל שלך?',
        subtitle: 'נשלח אליך קוד חד־פעמי למייל.',
  ...
  en: {
    ...
    auth: {
      ...
      phone: {
        ...
        subtitle: 'We will send you a one-time code to your inbox.',
...
const heOverrides: Record<string, string> = {
  ...
  'auth.phone.title': 'מה כתובת האימייל שלך?',
  'auth.phone.subtitle': 'נשלח אליך קוד חד פעמי למייל.',
  'auth.phone.placeholder': 'you@example.com',
